...
Get the token and replace `{{bear_token}}` in this doc with the actual value.
...
In step, the end user bought 10 physical goods with each unit priced at $30. An invoice is generated automatically with the total amount of $300.  
